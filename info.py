...
TEMPLATE = environ.get("TEMPLATE", "<b>{mention}'s Qᴜᴇʀʏ ☞ <code>{query}</code>\n\n<u>How to Open Link?</u>\n\n1️⃣ Open Link -> Scroll Down -> Click 'I am Not A Robot'\n2️⃣ Wait for 20 sec and Double tap and Click 'Go To Link'\n3️⃣ That's It Get TG File 📁😎\n\n🔅 Pᴏᴡᴇʀᴇᴅ Bʏ : @Team_HMT</b>")
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>{mention}'s Qᴜᴇʀʏ ☞ <code>{query}</code>\n\n<u>How to Open Link?</u>\n\n1️⃣ Open Link -> Scroll Down -> Click 'I am Not A Robot'\n2️⃣ Wait for 20 sec and Double tap and Click 'Go To Link'\n3️⃣That's It Get TG File 📁\n\n🔅 Pᴏᴡᴇʀᴇᴅ Bʏ : @Team_HMT</b>")
